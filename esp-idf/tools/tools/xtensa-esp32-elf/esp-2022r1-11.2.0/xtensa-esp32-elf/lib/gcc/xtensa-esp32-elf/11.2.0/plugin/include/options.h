...
#define MASK_SERIALIZE_VOLATILE (1U << 5)
...
enum opt_code
{
  ...
  OPT_list = 1675,                           /* -list */
  OPT_mabi_call0 = 1676,                     /* -mabi=call0 */
  OPT_mabi_windowed = 1677,                  /* -mabi=windowed */
  OPT_malways_memw = 1678,                   /* -malways-memw */
  OPT_mauto_litpools = 1679,                 /* -mauto-litpools */
  OPT_mconst16 = 1680,                       /* -mconst16 */
  OPT_mfix_esp32_psram_cache_issue = 1681,   /* -mfix-esp32-psram-cache-issue */
  OPT_mfix_esp32_psram_cache_strategy_ = 1682,/* -mfix-esp32-psram-cache-strategy= */
  OPT_mforce_no_pic = 1683,                  /* -mforce-no-pic */
  /* OPT_mfused_madd = 1684, */              /* -mfused-madd */
  OPT_mlongcalls = 1685,                     /* -mlongcalls */
  OPT_mserialize_volatile = 1686,            /* -mserialize-volatile */
  OPT_mtarget_align = 1687,                  /* -mtarget-align */
  OPT_mtext_section_literals = 1688,         /* -mtext-section-literals */
  OPT_n = 1689,                              /* -n */
  OPT_name_sort = 1690,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1691,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1692,              /* -no-integrated-cpp */
  OPT_no_pie = 1693,                         /* -no-pie */
  OPT_nocpp = 1694,                          /* -nocpp */
  OPT_nodefaultlibs = 1695,                  /* -nodefaultlibs */
  OPT_nolibc = 1696,                         /* -nolibc */
  OPT_nophoboslib = 1697,                    /* -nophoboslib */
  OPT_nostartfiles = 1698,                   /* -nostartfiles */
  OPT_nostdinc = 1699,                       /* -nostdinc */
  OPT_nostdinc__ = 1700,                     /* -nostdinc++ */
  OPT_nostdlib = 1701,                       /* -nostdlib */
  OPT_o = 1702,                              /* -o */
  OPT_objects = 1703,                        /* -objects */
  OPT_p = 1704,                              /* -p */
  OPT_pass_exit_codes = 1705,                /* -pass-exit-codes */
  /* OPT_pedantic = 1706, */                 /* -pedantic */
  OPT_pedantic_errors = 1707,                /* -pedantic-errors */
  OPT_pg = 1708,                             /* -pg */
  OPT_pie = 1709,                            /* -pie */
  OPT_pipe = 1710,                           /* -pipe */
  OPT_print_file_name_ = 1711,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1712,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1713,          /* -print-multi-directory */
  OPT_print_multi_lib = 1714,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1715,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1716,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1717,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1718,               /* -print-prog-name= */
  OPT_print_search_dirs = 1719,              /* -print-search-dirs */
  OPT_print_sysroot = 1720,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1721,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1722,                    /* -print-value */
  OPT_quiet = 1723,                          /* -quiet */
  OPT_r = 1724,                              /* -r */
  OPT_rdynamic = 1725,                       /* -rdynamic */
  OPT_remap = 1726,                          /* -remap */
  OPT_reverse_sort = 1727,                   /* -reverse-sort */
  OPT_s = 1728,                              /* -s */
  OPT_save_temps = 1729,                     /* -save-temps */
  OPT_save_temps_ = 1730,                    /* -save-temps= */
  OPT_shared = 1731,                         /* -shared */
  OPT_shared_libgcc = 1732,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1733,               /* -shared-libphobos */
  OPT_size_sort = 1734,                      /* -size-sort */
  /* OPT_specs = 1735, */                    /* -specs */
  OPT_specs_ = 1736,                         /* -specs= */
  OPT_static = 1737,                         /* -static */
  OPT_static_libasan = 1738,                 /* -static-libasan */
  OPT_static_libgcc = 1739,                  /* -static-libgcc */
  OPT_static_libgfortran = 1740,             /* -static-libgfortran */
  OPT_static_libgo = 1741,                   /* -static-libgo */
  OPT_static_libhwasan = 1742,               /* -static-libhwasan */
  OPT_static_liblsan = 1743,                 /* -static-liblsan */
  OPT_static_libmpx = 1744,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1745,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1746,               /* -static-libphobos */
  OPT_static_libstdc__ = 1747,               /* -static-libstdc++ */
  OPT_static_libtsan = 1748,                 /* -static-libtsan */
  OPT_static_libubsan = 1749,                /* -static-libubsan */
  OPT_static_pie = 1750,                     /* -static-pie */
  /* OPT_std_c__03 = 1751, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1752, */                /* -std=c++0x */
  OPT_std_c__11 = 1753,                      /* -std=c++11 */
  OPT_std_c__14 = 1754,                      /* -std=c++14 */
  OPT_std_c__17 = 1755,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1756, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1757, */                /* -std=c++1z */
  OPT_std_c__20 = 1758,                      /* -std=c++20 */
  OPT_std_c__23 = 1759,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1760, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1761, */                /* -std=c++2b */
  OPT_std_c__98 = 1762,                      /* -std=c++98 */
  OPT_std_c11 = 1763,                        /* -std=c11 */
  OPT_std_c17 = 1764,                        /* -std=c17 */
  /* OPT_std_c18 = 1765, */                  /* -std=c18 */
  /* OPT_std_c1x = 1766, */                  /* -std=c1x */
  OPT_std_c2x = 1767,                        /* -std=c2x */
  /* OPT_std_c89 = 1768, */                  /* -std=c89 */
  OPT_std_c90 = 1769,                        /* -std=c90 */
  OPT_std_c99 = 1770,                        /* -std=c99 */
  /* OPT_std_c9x = 1771, */                  /* -std=c9x */
  OPT_std_f2003 = 1772,                      /* -std=f2003 */
  OPT_std_f2008 = 1773,                      /* -std=f2008 */
  OPT_std_f2008ts = 1774,                    /* -std=f2008ts */
  OPT_std_f2018 = 1775,                      /* -std=f2018 */
  OPT_std_f95 = 1776,                        /* -std=f95 */
  OPT_std_gnu = 1777,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1778, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1779, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1780,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1781,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1782,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1783, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1784, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1785,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 1786,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1787, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1788, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 1789,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1790,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1791,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1792, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1793, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1794,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1795, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1796,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1797,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1798, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1799, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1800,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1801, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1802, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1803, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1804, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1805, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1806,                     /* -std=legacy */
  OPT_stdlib_ = 1807,                        /* -stdlib= */
  OPT_symbol_ = 1808,                        /* -symbol= */
  OPT_symbolic = 1809,                       /* -symbolic */
  OPT_t = 1810,                              /* -t */
  OPT_time = 1811,                           /* -time */
  OPT_time_ = 1812,                          /* -time= */
  OPT_traditional = 1813,                    /* -traditional */
  OPT_traditional_cpp = 1814,                /* -traditional-cpp */
  OPT_tree_stats = 1815,                     /* -tree-stats */
  OPT_trigraphs = 1816,                      /* -trigraphs */
  OPT_type_stats = 1817,                     /* -type-stats */
  OPT_u = 1818,                              /* -u */
  OPT_undef = 1819,                          /* -undef */
  OPT_v = 1820,                              /* -v */
  OPT_version = 1821,                        /* -version */
  OPT_w = 1822,                              /* -w */
  OPT_wrapper = 1823,                        /* -wrapper */
  OPT_x = 1824,                              /* -x */
  OPT_z = 1825,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
