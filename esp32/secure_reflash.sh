...
/home/einstein/.espressif/python_env/idf5.0_py3.10_env/bin/python ../esp-idf/components/esptool_py/esptool/esptool.py -p $1 -b 460800 --before default_reset --after no_reset --chip esp32 \
